...
(function (b) {
  ...
  var j = [],
    ...
    m =
      b.browser.msie &&
      6 === parseInt(b.browser.version) &&
      "object" !== typeof window.XMLHttpRequest,
  ...
  b.modal.impl = {
    ...
    bindEvents: function () {
      ...
      k.bind("resize.simplemodal orientationchange.simplemodal", function () {
        ...
        m || n
          ? a.fixIE()
          : a.o.modal &&
            (a.d.iframe && a.d.iframe.css({ height: h[0], width: h[1] }),
    ...
    getVal: function (a, b) {
      return a
        ? "number" === typeof a
          ...
          ? 0
          : 0 < a.indexOf("%")
          ? (parseInt(a.replace(/%/, "")) / 100) * ("h" === b ? h[0] : h[1])
    ...
    update: function (a, b) {
      ...
      this.d.data.fadeOut(600);
      a && this.d.container.css("height", a);
      b && this.d.container.css("width", b);
      this.setContainerDimensions();
      this.d.data.fadeIn(600);
    ...
    open: function () {
      this.d.iframe && this.d.iframe.fadeIn(600);
      b.isFunction(this.o.onOpen)
        ? this.o.onOpen.apply(this, [this.d])
        : (this.d.overlay.fadeIn(600),
          this.d.container.fadeIn(600),
          this.d.data.fadeIn(600));
      this.o.focus && this.focus();
      this.bindEvents();
    },
      ...
      if (b.isFunction(this.o.onClose) && !this.occb)
        ...
        if (this.d.placeholder) {
          ...
          this.o.persist
            ...
            : (this.d.data.fadeOut(600).remove(), a.replaceWith(this.d.orig));
        } else this.d.data.fadeOut(600).remove();
        this.d.container.fadeOut(600).remove();
        this.d.overlay.fadeOut(600);
        this.d.iframe && this.d.iframe.fadeOut(600).remove();
