!(function (o) {
    ...
    r ||
      (r = s.find(".wp-hide-pw")).show().on("click", function () {
        "password" === a.attr("type")
          ? (a.attr("type", "text"), b(!1))
          : (a.attr("type", "password"), b(!0));
      });
  }
  function k(e, s, a) {
      ...
      (a = o("#pass1, #mailserver_pass")).length
        ? ((d = a.val()),
          ...
          a.on("input pwupdate", function () {
            a.val() !== d &&
              ((d = a.val()), a.removeClass("short bad good strong"), x());
          }))
        : (a = o("#user_pass")),
      (t = o("#pass2").on("input", function () {
        0 < t.val().length &&
          (a.val(t.val()), t.val(""), (d = ""), a.trigger("pwupdate"));
      })),
  ...
  new ClipboardJS(".application-password-display .copy-button").on(
    "success",
    function (e) {
      var s = o(e.trigger),
      ...
      e.clearSelection(),
        ...
        wp.a11y.speak(
          v("Application password has been copied to your clipboard.")
        );
    }
  ),
    o(function () {
            ...
            function () {
              ...
              t.display_firstname &&
                ...
                o.each(t, function (e, s) {
                  s &&
                    ((s = s.replace(/<\/?[a-z][^>]*>/gi, "")), t[e].length) &&
                    -1 === o.inArray(s, a) &&
                    (a.push(s), o("<option />", { text: s }).appendTo(i));
                });
            }
          ),
            ...
            if (
              ((a =
                0 === a.length
                  ...
                  : a).attr("href", s.children(".css_url").val()),
